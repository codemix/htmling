...
Trees.LayoutStatement = astify(function LayoutStatement () {
  /* jshint ignore: start */
  function _scopeName (context, object, content, filterContext) {
    var html = '', ref;
    _body;
    return context.layout(_src, object, html);
  }
  html += _scopeName(context, object, content, filterContext);
  /* jshint ignore: end */
});

CustomTypes.LayoutStatement = function (node) {
  return Trees.LayoutStatement({
    src: {
      type: "Literal",
