...
exports.compile = function (input) {
  ...
  (new Function('module', 'exports', generated))(module, module.exports); // jshint ignore: line
...
function layout (name, object, content) {
  if (!this.layouts[name]) {
    return content;
  }
  else {
    return this.layouts[name].render(object, content);
  }
}